...
# Output:
# - dist/Sage.app
# - dist/Sage-<version>.zip
# - dist/Sage-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Sage-$VERSION.zip"
DMG="$ROOT_DIR/dist/Sage-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Sage-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Sage-$VERSION.dSYM.zip"
