## Sage Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_sage-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm sage gateway --port 18789 --verbose
```
