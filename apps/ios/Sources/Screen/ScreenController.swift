...
final class ScreenController {
    ...
    /// Callback invoked when an sage:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = SageKitResources.bundle
...
/// Handles navigation policy to intercept sage:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept sage:// deep links.
        if url.scheme?.lowercased() == "sage" {
