...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: SageLocationMode) async -> CLAuthorizationStatus {
    ...
    private static func accuracyValue(_ accuracy: SageLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
