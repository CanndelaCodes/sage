...
describe("overlay visual review generator", () => {
  ...
  it("builds a local review page for every smoke screenshot and MVP visual criterion", () => {
    ...
    for (const expected of [
      ...
      "Acceptance Decision Recorder",
      "acceptance-state",
      "acceptance-json",
      "sageos.overlay.visualReview",
      "All criteria accepted",
      "Copy acceptance JSON",
      "Save acceptance JSON",
      "save-acceptance-json",
      "acceptance-save-status",
      "fetch(\"/acceptance\"",
      "overlay-visual-review-acceptance.json",
      "Needs polish",
      "MVP blocker",
      "rubric-row",
      "decision-control",
  ...
  it("verifies the generated review page in a local browser", () => {
    ...
    for (const expected of [
      ...
      "acceptanceStateText",
      "acceptanceJsonText",
      "selectAllAcceptanceCriteria",
      "resetAcceptanceRecorder",
  ...
  it("serves the generated visual review packet on localhost", () => {
    ...
    for (const expected of [
      ...
      "overlay-visual-review-acceptance.json",
      "readRequestBody",
      "writeAcceptancePacket",
      "Invalid SageOS visual acceptance packet",
      "request.method === \"POST\"",
      "atomicWriteJson",
      "path.relative",
      "startsWith(\"..\")",
