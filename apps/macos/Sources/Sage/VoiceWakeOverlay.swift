...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.sage", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Sage windows, but below the system’s pop-up menus.
