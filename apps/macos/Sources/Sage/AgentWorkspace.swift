...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.sage", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SageConfigFile.defaultWorkspaceURL() }
