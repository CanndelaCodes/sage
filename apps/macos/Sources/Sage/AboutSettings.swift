...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/sage/sage") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/sage/sage")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://sage.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "SageBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "SageBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SageGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SageGitCommit") as? String) ??
            "unknown"
    }
