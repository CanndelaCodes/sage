...
enum UIStrings {
    static let welcomeTitle = "Welcome to Sage"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: SageOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: SageChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g sage@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SageChatViewModel(
