...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.sage", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Sage/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__sage__/a2ui/").absoluteString + "?platform=macos"
    }
