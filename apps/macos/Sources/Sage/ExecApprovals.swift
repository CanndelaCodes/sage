...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.sage", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        SagePaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        SagePaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
