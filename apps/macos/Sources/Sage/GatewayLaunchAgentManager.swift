...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.sage", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".sage/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.sageCommand(
            subcommand: "gateway",
