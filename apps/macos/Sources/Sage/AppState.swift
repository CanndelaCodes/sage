...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SageConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SageConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SageConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/sage"
        state.remoteCliPath = ""
        return state
    }
}
