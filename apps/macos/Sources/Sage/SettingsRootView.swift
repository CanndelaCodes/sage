...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .sageSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SagePaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SagePaths.stateDirURL.path
...
extension Notification.Name {
    static let sageSelectSettingsTab = Notification.Name("sageSelectSettingsTab")
}
