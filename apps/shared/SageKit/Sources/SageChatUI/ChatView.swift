...
@MainActor
public struct SageChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: SageChatViewModel
    ...
    private var visibleMessages: [SageChatMessage] {
        let base: [SageChatMessage]
    ...
    private func mergeToolResults(in messages: [SageChatMessage]) -> [SageChatMessage] {
    ...
    private func isToolResultMessage(_ message: SageChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SageChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SageChatMessage) -> String {
