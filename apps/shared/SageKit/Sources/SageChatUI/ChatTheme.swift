...
enum SagePlatformImageFactory {
    static func image(_ image: SagePlatformImage) -> Image {
        #if os(macOS)
        Image(nsImage: image)
        #else
        Image(uiImage: image)
