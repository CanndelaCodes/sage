...
public typealias SagePlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SagePlatformImage = UIImage
#endif

public struct SageChatUsageCost: Codable, Hashable, Sendable {
...
public struct SageChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SageChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SageChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SageChatMessageContent: Codable, Hashable, Sendable {
...
public struct SageChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SageChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SageChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SageChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SageChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SageChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SageChatMessageContent].self, forKey: .content) {
...
public struct SageChatHistoryPayload: Codable, Sendable {
...
public struct SageSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SageSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SageSessionPreviewItem]
}

public struct SageSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SageSessionPreviewEntry]

    public init(ts: Int, previews: [SageSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SageChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SageChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SageAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SageChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SageGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SagePendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SagePlatformImage?
...
public struct SageChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
