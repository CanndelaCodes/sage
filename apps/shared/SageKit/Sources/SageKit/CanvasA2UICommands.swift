...
public enum SageCanvasA2UICommand: String, Codable, Sendable {
...
public struct SageCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SageCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
