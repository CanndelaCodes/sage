...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = SageChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = SageChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
