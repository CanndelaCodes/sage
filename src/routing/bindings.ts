...
export function listBindings(cfg: SageConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: SageConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SageConfig) {
