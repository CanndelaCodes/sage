...
function resolveMentionPatterns(cfg: SageConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SageConfig | undefined, agentId?: string): RegExp[] {
