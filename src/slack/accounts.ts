...
export function listSlackAccountIds(cfg: SageConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: SageConfig): string {
...
function resolveAccountConfig(cfg: SageConfig, accountId: string): SlackAccountConfig | undefined {
  const accounts = cfg.channels?.slack?.accounts;
  if (!accounts || typeof accounts !== "object") {
    return undefined;
  }
...
function mergeSlackAccountConfig(cfg: SageConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: SageConfig): ResolvedSlackAccount[] {
