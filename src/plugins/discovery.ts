...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @sage/voice-call -> voice-call).
...
export function discoverSagePlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".sage", "extensions")];
