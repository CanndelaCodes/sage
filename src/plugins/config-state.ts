...
export const normalizePluginsConfig = (config?: SageConfig["plugins"]): NormalizedPluginsConfig => {
...
const hasExplicitMemorySlot = (plugins?: SageConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: SageConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: SageConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
