...
function resolveAnthropicDefaultAuthMode(cfg: SageConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SageConfig): SageConfig {
...
export function applyTalkApiKey(config: SageConfig): SageConfig {
...
export function applyModelDefaults(cfg: SageConfig): SageConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SageConfig): SageConfig {
...
export function applyLoggingDefaults(cfg: SageConfig): SageConfig {
...
export function applyContextPruningDefaults(cfg: SageConfig): SageConfig {
...
export function applyCompactionDefaults(cfg: SageConfig): SageConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
