...
export const A2UI_PATH = "/__sage__/a2ui";

export const CANVAS_HOST_PATH = "/__sage__/canvas";

export const CANVAS_WS_PATH = "/__sage__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.sageCanvasA2UIAction.postMessage(...)
  // - Android: window.sageCanvasA2UIAction.postMessage(...)
  const handlerNames = ["sageCanvasA2UIAction"];
  ...
  globalThis.Sage = globalThis.Sage ?? {};
  globalThis.Sage.postMessage = postToNode;
  globalThis.Sage.sendUserAction = sendUserAction;
  globalThis.sagePostMessage = postToNode;
  globalThis.sageSendUserAction = sendUserAction;
