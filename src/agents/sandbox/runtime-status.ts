...
function resolveMainSessionKeyForSandbox(params: { cfg?: SageConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: SageConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(`- See: ${formatCliCommand(`sage sandbox explain --session ${runtime.sessionKey}`)}`);
