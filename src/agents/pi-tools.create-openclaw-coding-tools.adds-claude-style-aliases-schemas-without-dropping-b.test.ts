...
describe("createSageCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createSageCodingTools({
      config,
    ...
    const anthropicTools = createSageCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createSageCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createSageCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
