...
function resolveAvatarSource(cfg: SageConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SageConfig, agentId: string): AgentAvatarResolution {
