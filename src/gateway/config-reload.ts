...
import type { SageConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: SageConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  ...
  onHotReload: (plan: GatewayReloadPlan, nextConfig: SageConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: SageConfig) => void;
  log: {
