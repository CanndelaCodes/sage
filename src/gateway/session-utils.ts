...
import { type SageConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: SageConfig): string[] {
...
export function listAgentsForGateway(cfg: SageConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: SageConfig): string {
...
function resolveSessionStoreAgentId(cfg: SageConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: SageConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: SageConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: SageConfig): GatewaySessionsDefaults {
