 ...
 *
 * @see https://github.com/sage/sage/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an SageConfig.
 */
export function timestampOptsFromConfig(cfg: SageConfig): TimestampInjectionOptions {
  return {
