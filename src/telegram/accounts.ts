...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SAGE_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: SageConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: SageConfig): string {
...
function mergeTelegramAccountConfig(cfg: SageConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: SageConfig): ResolvedTelegramAccount[] {
