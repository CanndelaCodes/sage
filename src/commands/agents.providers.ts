...
function resolveDefaultAccountId(cfg: SageConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SageConfig): boolean {
...
export function summarizeBindings(cfg: SageConfig, bindings: AgentBinding[]): string[] {
