...
const ensureSageModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveSageAgentDir = vi.fn().mockReturnValue("/tmp/sage-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/sage-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureSageModelsJson,
}));
