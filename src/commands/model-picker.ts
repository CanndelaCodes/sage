...
function resolveConfiguredModelRaw(cfg: SageConfig): string {
...
function resolveConfiguredModelKeys(cfg: SageConfig): string[] {
...
export function applyPrimaryModel(cfg: SageConfig, model: string): SageConfig {
...
export function applyModelAllowlist(cfg: SageConfig, models: string[]): SageConfig {
  const defaults = cfg.agents?.defaults;
