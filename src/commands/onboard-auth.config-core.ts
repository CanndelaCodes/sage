...
export function applyZaiConfig(cfg: SageConfig): SageConfig {
...
export function applyOpenrouterProviderConfig(cfg: SageConfig): SageConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: SageConfig): SageConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: SageConfig): SageConfig {
...
export function applyOpenrouterConfig(cfg: SageConfig): SageConfig {
...
export function applyMoonshotProviderConfig(cfg: SageConfig): SageConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: SageConfig): SageConfig {
...
export function applyMoonshotConfig(cfg: SageConfig): SageConfig {
...
export function applyMoonshotConfigCn(cfg: SageConfig): SageConfig {
...
export function applyKimiCodeProviderConfig(cfg: SageConfig): SageConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: SageConfig): SageConfig {
...
export function applySyntheticProviderConfig(cfg: SageConfig): SageConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: SageConfig): SageConfig {
...
export function applyXiaomiProviderConfig(cfg: SageConfig): SageConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: SageConfig): SageConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: SageConfig): SageConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: SageConfig): SageConfig {
