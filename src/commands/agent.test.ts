...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "sage-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<SageConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<SageConfig["telegram"]>>,
