...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.SAGE_STATE_DIR;
  const configPath = env.SAGE_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    SAGE_PROFILE: profile,
    SAGE_STATE_DIR: stateDir,
    SAGE_CONFIG_PATH: configPath,
    SAGE_GATEWAY_PORT: String(port),
    SAGE_GATEWAY_TOKEN: token,
    SAGE_LAUNCHD_LABEL: resolvedLaunchdLabel,
    SAGE_SYSTEMD_UNIT: systemdUnit,
    SAGE_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    SAGE_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    SAGE_STATE_DIR: stateDir,
    SAGE_CONFIG_PATH: configPath,
    SAGE_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    SAGE_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    SAGE_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    SAGE_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    SAGE_LOG_PREFIX: "node",
    SAGE_SERVICE_MARKER: NODE_SERVICE_MARKER,
    SAGE_SERVICE_KIND: NODE_SERVICE_KIND,
    SAGE_SERVICE_VERSION: VERSION,
  };
}
