...
export function listWhatsAppAuthDirs(cfg: SageConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SageConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: SageConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: SageConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: SageConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SageConfig): ResolvedWhatsAppAccount[] {
