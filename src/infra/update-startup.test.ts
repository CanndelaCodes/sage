...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "sage-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveSagePackageRoot } = await import("./sage-root.js");
    ...
    vi.mocked(resolveSagePackageRoot).mockResolvedValue("/opt/sage");
