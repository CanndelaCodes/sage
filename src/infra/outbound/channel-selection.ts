...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: SageConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: SageConfig): Promise<MessageChannelId[]> {
