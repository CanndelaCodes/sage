...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: SageConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: SageConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: SageConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: SageConfig): void {
