...
export function listIMessageAccountIds(cfg: SageConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: SageConfig): string {
...
function mergeIMessageAccountConfig(cfg: SageConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: SageConfig): ResolvedIMessageAccount[] {
