...
import type { SagePackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverSagePlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, SagePackageManifest>>;
...
const ENV_CATALOG_PATHS = ["SAGE_PLUGIN_CATALOG_PATHS", "SAGE_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<SagePackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: SagePackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverSagePlugins({ workspaceDir: options.workspaceDir });
