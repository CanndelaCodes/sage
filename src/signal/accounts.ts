...
export function listSignalAccountIds(cfg: SageConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: SageConfig): string {
...
function resolveAccountConfig(cfg: SageConfig, accountId: string): SignalAccountConfig | undefined {
  const accounts = cfg.channels?.signal?.accounts;
  if (!accounts || typeof accounts !== "object") {
    return undefined;
  }
...
function mergeSignalAccountConfig(cfg: SageConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SageConfig): ResolvedSignalAccount[] {
