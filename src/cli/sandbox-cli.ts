...
const SANDBOX_EXAMPLES = {
  main: [
    ["sage sandbox list", "List all sandbox containers."],
    ["sage sandbox list --browser", "List only browser containers."],
    ["sage sandbox recreate --all", "Recreate all containers."],
    ["sage sandbox recreate --session main", "Recreate a specific session."],
    ["sage sandbox recreate --agent mybot", "Recreate agent containers."],
    ["sage sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["sage sandbox list", "List all sandbox containers."],
    ["sage sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["sage sandbox recreate --all", "Recreate all containers."],
    ["sage sandbox recreate --session main", "Recreate a specific session."],
    ["sage sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["sage sandbox recreate --browser --all", "Recreate only browser containers."],
    ["sage sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["sage sandbox explain", "Show effective sandbox config."],
    ["sage sandbox explain --session agent:main:main", "Explain a specific session."],
    ["sage sandbox explain --agent work", "Explain an agent sandbox."],
    ["sage sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.sage.ai/cli/sandbox")}\n`,
    )
    .action(() => {
