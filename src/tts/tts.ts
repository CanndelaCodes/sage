...
export function resolveTtsConfig(cfg: SageConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.SAGE_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: SageConfig): string | undefined {
...
function resolveSummaryModelRef(cfg: SageConfig, config: ResolvedTtsConfig): SummaryModelSelection {
