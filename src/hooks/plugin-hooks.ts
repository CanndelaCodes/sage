...
import type { SagePluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: SagePluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: SagePluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
