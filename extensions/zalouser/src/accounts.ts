...
export function listZalouserAccountIds(cfg: SageConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: SageConfig): string {
...
function mergeZalouserAccountConfig(cfg: SageConfig, accountId: string): ZalouserAccountConfig {
