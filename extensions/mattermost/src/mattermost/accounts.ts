...
export function listMattermostAccountIds(cfg: SageConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: SageConfig): string {
...
function mergeMattermostAccountConfig(cfg: SageConfig, accountId: string): MattermostAccountConfig {
...
export function listEnabledMattermostAccounts(cfg: SageConfig): ResolvedMattermostAccount[] {
