...
Nostr DM channel plugin for Sage using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Sage. It enables your bot to:
...
# Configure sage to use local relay
