...
export function listGoogleChatAccountIds(cfg: SageConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: SageConfig): string {
...
function mergeGoogleChatAccountConfig(cfg: SageConfig, accountId: string): GoogleChatAccountConfig {
...
export function listEnabledGoogleChatAccounts(cfg: SageConfig): ResolvedGoogleChatAccount[] {
