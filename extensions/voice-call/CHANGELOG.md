...
- Version alignment with core Sage release numbers.
...
- First public release of the @sage/voice-call plugin.
...
- CLI: `sage voicecall` commands (call/start/continue/speak/end/status/tail/expose).
