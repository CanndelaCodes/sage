...
This directory contains the **BlueBubbles external channel plugin** for Sage.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `sage/plugin-sdk` helpers.
