...
export function listBlueBubblesAccountIds(cfg: SageConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: SageConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: SageConfig): ResolvedBlueBubblesAccount[] {
