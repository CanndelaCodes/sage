...
import type { ReplyPayload, SageConfig } from "sage/plugin-sdk";
import { createReplyPrefixOptions } from "sage/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as SageConfig;
