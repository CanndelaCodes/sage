---
summary: "Use Synthetic's Anthropic-compatible API in Sage"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Sage registers it as the
...
Note: Sage's Anthropic client appends `/v1` to the base URL, so use
