---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Sage"
read_when:
  - You want Xiaomi MiMo models in Sage
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Sage uses
