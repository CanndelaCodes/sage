...
You can point Sage at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Sage
...
- [Anthropic provider](/providers/anthropic) - Native Sage integration with Claude setup-token or API keys
