...
Sage ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Sage also aligns
the install method:
...
When you switch channels with `sage update`, Sage also syncs plugin sources:
