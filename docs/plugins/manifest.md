...
read_when:
  - You are building a Sage plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (sage.plugin.json)

Every plugin **must** ship a `sage.plugin.json` file in the **plugin root**.
Sage uses this manifest to validate configuration **without executing plugin
