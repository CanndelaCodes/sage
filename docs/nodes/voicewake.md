...
Sage treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.sage/settings/voicewake.json`

Shape:

```json
{ "triggers": ["sage", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
