...
- Liquid Linear material and contrast closeout on 2026-06-04:
  ...
  - `pnpm --dir apps/windows-overlay smoke:electron` passed with `ok: true`, `defaultHotkeyToggles: 2`, `passThroughProbeClicks: 1`, and refreshed full, bright, Edge Rail, text-heavy Edge Rail, browser Edge Rail, IDE Edge Rail, HUD, and IDE HUD screenshots.
