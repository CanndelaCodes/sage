...
| Enterprise-grade Liquid Linear overlay visual gate                                                                                                   | Yellow | Visual contract tests, no-live-texture/root-no-full-screen-blur guard, practical AA text contrast guard, runtime reduced-motion smoke, app-like underlay screenshots, screenshot pixel-content sampling, Liquid Linear spec, smoke artifact, and `review:visual:all` pass                                                                                                                                                   | Jason visual acceptance                 |
