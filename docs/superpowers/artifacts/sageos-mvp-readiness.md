...
- The Windows overlay now has overlay-native Sage AI Chat backed by the local Gateway chat protocol, including visible composer controls, streaming state, session reset, and a Command Deck `system/chat` drill-down.
