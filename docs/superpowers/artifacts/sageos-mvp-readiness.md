...
| Overlay-native Sage AI Chat                                                                                                                          | Green  | Overlay renderer model, `system/chat` workspace, Gateway chat RPC helpers, controller chat event state, visual contract anti-collapse guard, packaged Electron smoke, visual review packet                                                                                                                                                                                                                 | Re-run overlay chat and smoke gates     |
