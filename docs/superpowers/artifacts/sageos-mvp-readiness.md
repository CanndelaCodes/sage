...
- Overlay-native Sage AI Chat closeout on 2026-06-04:
  ...
  - A one-off Electron bounding-box inspection caught the chat panel body overflowing under the Command Deck; the visual contract now enforces `.sage-ai-chat` content rows and `min-height: 336px`.
