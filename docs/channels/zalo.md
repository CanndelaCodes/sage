...
- Install via CLI: `sage plugins install @sage/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `sage plugins install ./extensions/zalo`
   - From npm (if published): `sage plugins install @sage/zalo`
...
- Approve via:
  - `sage pairing list zalo`
  - `sage pairing approve zalo <CODE>`
...
- Example: `sage message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `sage channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `sage logs --follow`
