...
Sage has two separate “streaming” layers:
...
When block streaming is enabled, Sage can **merge consecutive block chunks**
...
When draft streaming is active, Sage disables block streaming for that reply to avoid double-streaming.
